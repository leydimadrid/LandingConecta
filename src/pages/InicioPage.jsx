  ...
  return (
    <section id="inicio" className="area py-40 md:h-screen h-auto">
      <div className="mt-2 md:my-40 mx-auto text-center flex flex-col justify-center items-center w-full md:w-2/4">
        ...
        <h1 className="bienvenida mb-8 text-3xl md:text-6xl leading-tight text-purple-900 font-semibold">
        ...
        <a href="#portafolio">
          <button
            className= "bg-purple-800 block hover:bg-purple-900 font-semibold rounded-lg text-white hover:scale-105 px-8 py-2 mx-auto cursor-pointer shadow-xl my-6 text-xl tracking-wide"
          >
            Portafolio
          </button>
        </a>
